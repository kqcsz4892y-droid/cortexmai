          ...
          {({ open }) => (
            <>
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                <Link href="/">
                  <a className="flex items-center space-x-3 text-2xl font-bold text-white tracking-wide hover:opacity-80 transition-opacity">
                    <div className="relative">
                      <img
                        src="/img/CortexM AI Logo in Monochrome Black-6.png"
                        alt="CortexM AI Logo"
                        width={48}
                        height={48}
                    ...
                    <span className="text-white dark:text-white font-bold tracking-wide">
                      CortexM AI
                    </span>
                  </a>
                </Link>
